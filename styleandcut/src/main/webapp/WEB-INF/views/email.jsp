...
<html lang="en">
  ...
  <body>
	...
	<form:form action="${pageContext.request.contextPath}/Admin/email" method="post">
		<div>
			<p>To:</p> 
			<textarea rows="1" cols="30" name="to"></textarea>
		</div>
		<div>
			<p>Subject:</p> 
			<textarea rows="1" cols="40" name="subject"></textarea>
		</div>
