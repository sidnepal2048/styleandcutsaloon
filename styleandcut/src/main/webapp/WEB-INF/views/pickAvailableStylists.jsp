  ...
  <body>
    ...
    <div class="container-wrapper">
    	<div class="container">
            ...
            <c:forEach items="${stylistName}" var="stylist">
                <tr>
                    
                    <td>${stylist.stylistName}</td>
                   <td><a href="<spring:url value="/RegisterCustomer/selectedAppointment/${stylist.stylistId}" />">Confirm</a></td>
